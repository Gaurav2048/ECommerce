...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.viewHolder> implements ProductActions {
   Context context;
   boolean isShimmering= false;
   List<Product> productList;
   ClickListner clickListner;

    public PopularAdapter(@NonNull Context context, ClickListner clickListner) {
